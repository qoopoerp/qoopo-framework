...
@Getter
@Setter
public abstract class AbstractEagerEntityDetailCrudCompleteController<S extends AbstractEntity, T>
        extends AbstractEagerEntityCrudCompleteController<S> {

    public AbstractEagerEntityDetailCrudCompleteController(String entityClassName, Class<S> entityClass, Filter inicial,
            List<Condition> condicionesDisponibles, List<Field> campos, List<OpcionBase> opcionesGrupos) {
