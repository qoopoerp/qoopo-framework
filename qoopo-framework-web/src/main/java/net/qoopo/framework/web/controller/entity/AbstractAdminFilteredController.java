...
@Getter
@Setter
public abstract class AbstractAdminFilteredController<T extends AbstractEntity>
        extends AbstractAdminEntityFilteredController<T, T, Long>
        implements AdminBeanProgressable {

    public AbstractAdminFilteredController(String entityClassName, Class<T> entityClass, Filter inicial,
