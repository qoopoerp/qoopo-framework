...
/**
 * Implementación de un compressor GZIP
 * 
 * @author alberto
 */
public class GZIPCompressor implements ICompressor {
    ...
    public byte[] compress(byte[] datos) throws Exception {
        byte[] compressed;
    ...
    public byte[] decompress(byte[] datos) throws Exception {
    ...
    public byte[] compressObject(Object objeto) {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            objectOut.close();
            bytes = compress(baos.toByteArray());
        } catch (Exception ex) {
    ...
    public Object decompressObject(byte[] bytes) {
        ...
        try (ByteArrayInputStream bais = new ByteArrayInputStream(decompress(bytes));
    ...
    private void compressFiles(List<File> files, File outputFile, boolean mantenerRutas, String rutaAeliminar)
            throws Exception {
        File tmpFile = new File(outputFile.getAbsolutePath() + ".tmp");
     ...
     * @return
     */
    private List<File> getAllFiles(File ruta) {
