...
public class OpcionBase implements Serializable {
    ...
    public final static OpcionBase DEFAULT = new OpcionBase(-1000, "common.default", "Default");
    public final static int SIN_GRUPO_CODE = -1001;
    public final static OpcionBase SIN_GRUPO = new OpcionBase(SIN_GRUPO_CODE, "common.nogroup", "Sin grupo");

    private int codigo; // el codigo que se usa para evaluar en las entidades
    private String codigoTexto; // el codigo del texto
    ...
    public OpcionBase(int codigo, String codigoTexto, String texto) {
        this.codigo = codigo;
        this.codigoTexto = codigoTexto;
        this.texto = texto;
    }

    public OpcionBase(int codigo, String codigoTexto, String texto, int nivel) {
        this.codigo = codigo;
        this.codigoTexto = codigoTexto;
        this.texto = texto;
        this.nivel = nivel;
