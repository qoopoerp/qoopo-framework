package net.qoopo.qoopoframework.jpa.filter;
...
public class Filter implements Serializable {
    ...
    public Filter(String nombre, Condicion condicion) {
        this.nombre = nombre;
        this.condicion = condicion;
    }

    public Filter(String nombre, String tablaJPL, Condicion condicion) {
        this.nombre = nombre;
        this.tablaJPL = tablaJPL;
        this.condicion = condicion;
    }
    ...
    public Filter setNombre(String nombre) {
        this.nombre = nombre;
        return this;
    }
    ...
    public Filter setCondicion(Condicion condicion) {
        this.condicion = condicion;
        return this;
    }
    ...
    public static class Builder implements QoopoBuilder<Filter> {
